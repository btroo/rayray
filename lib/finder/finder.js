...
module.exports = {
	getDifferentTokens: function(input){
	...
	getDifferentTokensAndCount: function(input){
		var parsed = tokenizer.tokenize(input);
		var tokensAndCount = [];
	...
	getVocabAndCount: function(input){
		var parsed = tokenizer.tokenize(input),
			vocabAndCount = {},
			vc = [];
